...
;function Ec(){function a(){e[0]=1732584193;e[1]=4023233417;e[2]=2562383102;e[3]=271733878;e[4]=3285377520;n=l=0}
...
;function Fc(a,b,c){var d=[],e=[];if(1==(Ba(c)?2:1))return e=[b,a],F(d,function(g){e.push(g)}),Gc(e.join(" "));
...
a=Gc(e.join(" "));a=[c,a];0==h.length||a.push(h.join(""));return a.join("_")}
function Gc(a){var b=Ec();b.update(a);return b.xa().toLowerCase()}
...
Qc.prototype.reset=function(){this.next=this.scope=this.f=null};function Tc(a,b){Uc||Vc();Wc||(Uc(),Wc=!0);Xc.add(a,b)}
...
D($c,Zc);$c.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.j=this.h=0};
...
$c.prototype.digest=function(){var a=[],b=8*this.j;56>this.h?this.update(this.i,56-this.h):this.update(this.i,this.g-(this.h-56));for(var c=this.g-1;56<=c;c--)this.l[c]=b&255,b/=256;ad(this,this.l);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.f[c]>>d&255,++b;return a};function M(){this.g=this.g;this.C=this.C}
M.prototype.g=!1;M.prototype.dispose=function(){this.g||(this.g=!0,this.o())};
function bd(a,b){a.g?b():(a.C||(a.C=[]),a.C.push(b))}
...
N.prototype.cancel=function(a){if(0==this.f){var b=new Fd(a);Tc(function(){Gd(this,b)},this)}};
...
function Kd(a){a.l||(a.l=!0,Tc(a.C,a))}
...
function Md(a,b){a.j=!0;Tc(function(){a.j&&Od.call(null,b)})}
var Od=Mc;function Fd(a){E.call(this,a)}
...
function ze(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(r){}try{var e=b.outerWidth;var f=b.outerHeight}catch(r){}try{var h=b.innerWidth;var g=b.innerHeight}catch(r){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,h,g];c=a.f.top;try{var k=(c||window).document,l="CSS1Compat"==k.compatMode?k.documentElement:k.body;var n=(new lc(l.clientWidth,l.clientHeight)).round()}catch(r){n=new lc(-12245933,-12245933)}k=n;n={};l=new Ic;x.SVGElement&&
x.document.createElementNS&&l.set(0);c=Ac();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);x.crypto&&x.crypto.subtle&&l.set(3);x.TextDecoder&&x.TextEncoder&&l.set(4);l=Jc(l);n.bc=l;n.bih=k.height;n.biw=k.width;n.brdim=b.join();a=a.g;return n.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,n.wgl=!!L.WebGLRenderingContext,n}
...
function rg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ob||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().nb:b=Hc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
function sg(a){a=Object.assign({},a);delete a.Authorization;var b=Hc();if(b){var c=new $c;c.update(Q("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ca(b);void 0===c&&(c=0);if(!ec){ec={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var h=d.concat(e[f].split(""));dc[f]=h;for(var g=0;g<h.length;g++){var k=h[g];void 0===ec[k]&&(ec[k]=g)}}}c=dc[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],n=(f=e+1<b.length)?
...
;function ej(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);bd(this,Ka(cd,this.f))}
...
m.dispose=function(){nj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function rj(a,b,c){M.call(this);this.f=a;this.i=c;this.j=X(window,"message",B(this.l,this));this.h=new fj(this,a,b);bd(this,Ka(cd,this.h))}
...
null):f.loadNewVideoConfig(a):(f=new Zh(b,e,a,void 0),ni[e]=f,gf("player-added",f.api),bd(f,Ka(pi,f)));a=f.api;Kj=a;a.addEventListener("onScreenChanged",Pj);a.addEventListener("onLogClientVeCreated",Oj);a.addEventListener("onLogServerVeCreated",Qj);a.addEventListener("onLogVeClicked",Rj);a.addEventListener("onLogVesShown",Sj);d=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Mj=new qj(a):Q("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(Lj=new rj(window.parent,d,c),Mj=new lj(a,Lj.h));
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&ch.dispose();a=0;for(var b=Xg.length;a<b;a++){var c=Xg[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):T(c)}}Xg.length=0;Vg("//static.doubleclick.net/instream/ad_status.js");Yg=!1;P("DCLKSTAT",0);dd(Mj,Lj);if(a=Kj)a.removeEventListener("onScreenChanged",Pj),a.removeEventListener("onLogClientVeCreated",Oj),a.removeEventListener("onLogServerVeCreated",Qj),a.removeEventListener("onLogVeClicked",Rj),a.removeEventListener("onLogVesShown",
Sj),a.destroy();Nj={}});
